...
<a class="inline-flex items-center justify-center bg-slate-900 text-white px-6 py-3 rounded-full hover:scale-105 transition-transform shadow-lg font-medium" href="https://drive.google.com/uc?export=download&id=1Ed2XJBL7EaEInx147vLqxvnKYni8dT7S">Download</a>
</div>
</div>
