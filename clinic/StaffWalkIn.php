...
if (($_SERVER['REQUEST_METHOD'] ?? '') === 'POST' && isset($_GET['action']) && (string) $_GET['action'] === 'create_walkin') {
            ...
            <div class="xl:col-span-4 xl:row-span-2 flex min-h-0 self-stretch order-1">
                <div class="elevated-card rounded-3xl p-4 sm:p-6 h-full min-h-0 w-full flex flex-col">
                    ...
                    <div class="space-y-3 flex-1 flex flex-col min-h-0">
                        ...
                        <div class="rounded-2xl border border-slate-100 bg-slate-50/60 flex-1 min-h-[14rem] sm:min-h-[18rem] xl:min-h-[22rem] overflow-y-auto">
...
<div id="chooseDentistModal" class="hidden fixed inset-0 z-[70] flex items-end sm:items-center justify-center p-0 sm:p-4">
    <div class="absolute inset-0 bg-slate-900/45 backdrop-blur-sm" data-modal-dismiss="choose-dentist"></div>
...
<div id="chooseServiceModal" class="hidden fixed inset-0 z-[70] flex items-end sm:items-center justify-center p-0 sm:p-4">
    <div class="absolute inset-0 bg-slate-900/45 backdrop-blur-sm" data-modal-dismiss="choose-service"></div>
