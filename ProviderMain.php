    ...
    <main>
        ...
        <section class="bg-primary py-16 sm:py-20 lg:py-24 reveal overflow-hidden" data-reveal="section">
            <div class="max-w-[1800px] mx-auto px-6 sm:px-8 lg:px-10 xl:px-14">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 xl:gap-20 items-center">
                    <div class="relative z-10 max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
                        <div
                        ...
                        <a href="Provider-Plans.php"
                            class="bg-white text-primary px-10 sm:px-16 py-5 sm:py-6 rounded-full font-black text-sm uppercase tracking-[0.2em] hover:scale-[1.03] transition-transform duration-200 shadow-2xl active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60 inline-block">
                            Start Your Subscription
                        </a>
                    </div>
                    <div
                        class="relative w-full max-w-xl mx-auto lg:max-w-none lg:mx-0 rounded-3xl overflow-hidden shadow-[0_40px_100px_-20px_rgba(0,0,0,0.25)] ring-1 ring-white/20">
                        <img src="Banner2.webp"
                            alt="Dental professionals collaborating with modern clinic software"
                            class="w-full h-auto object-cover object-center block" loading="lazy" decoding="async" />
                    </div>
                </div>
            </div>
        </section>
