...
?>
<header class="provider-top-header fixed top-0 right-0 left-64 z-30 min-h-[4.75rem] sm:h-20 sm:min-h-0 bg-white/90 backdrop-blur-xl border-b border-slate-200/60 shadow-sm shadow-slate-200/30" data-purpose="top-header">
<div class="flex items-center justify-between gap-3 pl-16 pr-4 sm:px-6 lg:px-10 py-3 sm:py-0 sm:h-full">
...
<button type="button" class="hover:bg-surface-container-low rounded-full p-2.5 transition-all relative border-0 bg-transparent cursor-pointer inline-flex" aria-label="Notifications">
