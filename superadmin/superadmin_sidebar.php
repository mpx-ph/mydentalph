 ...
 * dashboard | messages | tenantmanagement | subscriptions | salesreport | reports | auditlogs | superadmin_approval | adddevs | settings
 */
if (!isset($pdo)) {
...
$navMain = [
    ...
    ['key' => 'subscriptions', 'href' => 'subscriptions.php', 'icon' => 'subscriptions', 'label' => 'Subscriptions'],
