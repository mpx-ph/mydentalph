...
/**
 * Provider tenant portal sidebar. Requires $provider_nav_active: dashboard|users|subs|settings
...
<a class="<?php echo $base . ' ' . ($isActive ? $active : $idle); ?>" data-purpose="nav-item" href="<?php echo htmlspecialchars($meta['href'], ENT_QUOTES, 'UTF-8'); ?>">
