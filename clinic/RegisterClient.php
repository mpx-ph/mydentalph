...
<body class="bg-surface min-h-screen flex flex-col items-center selection:bg-primary/20 text-on-surface font-body relative overflow-x-hidden">
<!-- Navigation -->
...
<div class="flex flex-col items-center mb-8 text-on-surface">
...
<div class="bg-white rounded-3xl overflow-hidden p-8 sm:p-12 shadow-2xl border-2 border-primary">
...
<div class="w-full pt-6 border-t border-outline-variant flex flex-col items-center">
<p class="text-on-surface-variant text-sm mb-4">Already a member?</p>
<a class="group inline-flex items-center text-primary font-bold text-sm hover:text-primary-dark transition-colors no-underline" href="<?php echo htmlspecialchars($loginPageUrl, ENT_QUOTES, 'UTF-8'); ?>">
<span class="material-symbols-outlined text-xl mr-2 group-hover:translate-x-[-2px] transition-transform">login</span>
                        Log in here
                    </a>
</div>
</div>
<footer class="mt-8 text-center text-on-surface-variant text-[10px] uppercase tracking-[0.2em] leading-loose">
