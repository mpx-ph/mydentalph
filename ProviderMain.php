...
<title>MyDental - Modern Dental Clinic Management</title>
...
<h1 class="text-4xl font-extrabold tracking-tight text-slate-900 dark:text-white sm:text-6xl">
                            Manage Your Dental Clinic <span class="text-primary">Efficiently</span> with MyDental
                        </h1>
...
<button class="text-base font-bold text-white hover:underline underline-offset-4 decoration-2">
                                Contact Sales Team
                            </button>
</div>
</div>
