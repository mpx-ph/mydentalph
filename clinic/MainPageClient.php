...
<h2 class="font-headline text-6xl md:text-8xl font-extrabold tracking-tighter leading-[0.9] mb-8 text-slate-900 dark:text-white"><?php echo $cu('main_services_title'); ?></h2>
