...
?>
<header class="sa-top-header fixed top-0 right-0 w-[calc(100%-16rem)] h-20 z-30 bg-white/70 backdrop-blur-xl border-b border-white/50 flex items-center justify-between pl-24 pr-4 sm:pr-8 lg:px-8 transition-[width] duration-200">
<div class="flex items-center gap-4 sm:gap-6 flex-1 min-w-0">
<span class="text-lg sm:text-xl font-extrabold text-on-surface whitespace-nowrap">
