...
<a class="flex items-center gap-3 px-4 py-3 bg-primary/10 text-primary rounded-xl transition-all duration-200 active-glow" href="ManagerUsers.php">
<span class="material-symbols-outlined text-[22px]" style="font-variation-settings: 'FILL' 1;">people</span>
<span class="font-headline text-sm font-bold tracking-tight">Users</span>
</a>
