...
<p class="text-slate-600 dark:text-slate-400 leading-relaxed">
                                        <?php echo nl2br($cu('contact_address')); ?>
                                    </p>
<a class="inline-flex items-center gap-1 text-primary text-sm font-bold mt-3 hover:gap-2 transition-all" href="<?php echo $cu('contact_map_link'); ?>" target="_blank" rel="noopener noreferrer">
...
<a class="text-slate-900 dark:text-slate-200 font-medium hover:text-primary transition-colors" href="tel:<?php echo preg_replace('/\s+/', '', $cu('contact_phone')); ?>"><?php echo $cu('contact_phone'); ?></a>
</div>
<div class="flex flex-col">
<span class="text-xs font-semibold text-slate-400 uppercase tracking-wide">Email</span>
<a class="text-slate-900 dark:text-slate-200 font-medium hover:text-primary transition-colors" href="mailto:<?php echo $cu('contact_email'); ?>"><?php echo $cu('contact_email'); ?></a>
</div>
</div>
</div>
</div>
...
<span class="px-2 py-1 rounded bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold text-xs"><?php echo $cu('contact_hours_mon_fri'); ?></span>
</div>
<div class="flex justify-between items-center text-sm">
<span class="text-slate-500 dark:text-slate-400 font-medium">Saturday</span>
<span class="px-2 py-1 rounded bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 font-bold text-xs"><?php echo $cu('contact_hours_sat'); ?></span>
</div>
<div class="flex justify-between items-center text-sm">
<span class="text-slate-500 dark:text-slate-400 font-medium">Sunday</span>
<span class="px-2 py-1 rounded bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 font-bold text-xs"><?php echo $cu('contact_hours_sun'); ?></span>
</div>
</div>
</div>
</div>
...
<a class="font-bold text-base sm:text-lg hover:text-primary transition-colors pointer-events-auto inline-flex items-center gap-1" href="<?php echo $cu('contact_map_link'); ?>" target="_blank" rel="noopener noreferrer">
